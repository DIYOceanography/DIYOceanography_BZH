...
# -*- coding: utf-8 -*-
#
# xrft documentation build configuration file, created by
...
#
html_theme_options = {
    "repository_url": "https://github.com/DIYOceanography/DIYOceanography_BZH",
...
latex_documents = [
    (
        master_doc,
        "diyocean.tex",
        "DIY Oceanography BZH Documentation",
        "DIY Oceanography BZH team",
        "manual",
    ),
]
...
man_pages = [(master_doc, "diyoceanbzh", "DIY Oceanography BZH Documentation", [author], 1)]
